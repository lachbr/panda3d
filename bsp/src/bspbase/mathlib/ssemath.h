...
extern _BSPEXPORT const ALIGN_16BYTE uint32_t g_SIMD_signmask[] ALIGN16_POST;          // 0x80000000 x 4
extern _BSPEXPORT const ALIGN_16BYTE uint32_t g_SIMD_lsbmask[] ALIGN16_POST;           // 0xfffffffe x 4
extern _BSPEXPORT const ALIGN_16BYTE uint32_t g_SIMD_clear_wmask[] ALIGN16_POST;       // -1 -1 -1 0
extern _BSPEXPORT const ALIGN_16BYTE uint32_t g_SIMD_ComponentMask[4][4] ALIGN16_POST; // [0xFFFFFFFF 0 0 0], [0 0xFFFFFFFF 0 0], [0 0 0xFFFFFFFF 0], [0 0 0 0xFFFFFFFF]
extern _BSPEXPORT const ALIGN_16BYTE uint32_t g_SIMD_AllOnesMask[] ALIGN16_POST;       // ~0,~0,~0,~0
...
extern _BSPEXPORT const uint32_t ALIGN_16BYTE g_SIMD_SkipTailMask[4][4] ALIGN16_POST;
