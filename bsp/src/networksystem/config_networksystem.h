...
#define EXPTP_NETWORKSYSTEM EXPORT_TEMPL
#else
#define EXPCL_NETWORKSYSTEM IMPORT_CLASS
#define EXPTP_NETWORKSYSTEM IMPORT_TEMPL
#endif

ConfigureDecl(config_networksystem, EXPCL_NETWORKSYSTEM, EXPTP_NETWORKSYSTEM);

NotifyCategoryDecl(networksystem, EXPCL_NETWORKSYSTEM, EXPTP_NETWORKSYSTEM);
