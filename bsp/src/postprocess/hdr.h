...
extern EXPCL_BSP_POSTPROCESS ConfigVariableBool hdr_auto_exposure;
...
class EXPCL_BSP_POSTPROCESS HDRPass : public PostProcessPass
{
...
class EXPCL_BSP_POSTPROCESS HDREffect : public PostProcessEffect
{
PUBLISHED:
